...
// instead of an absolute date. Also handles future timestamps (a trash
// entry's purge date, 30 days out) by flipping to "in Xd" instead of
// collapsing to "just now".
